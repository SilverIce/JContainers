...
public:
	...
	DEFINE_MEMBER_FN(Destroy, void, 0x0124DED0);
	DEFINE_MEMBER_FN(GetVariable, SInt32, 0x00000000, BSFixedString * name);
	DEFINE_MEMBER_FN(GetFunction, IFunction*, 0x00000000, const char * fnName);
};
...
//	void						** _vtbl;								// 0000
	...
	DEFINE_MEMBER_FN(UnregisterFromSleep_Internal, void, 0x00924430, UInt64 handle);
	DEFINE_MEMBER_FN(RevertGlobalData_Internal, bool, 0x0092D730);
	// E79F47684196468F785E6950402DBDAA5A668FAA+110
	DEFINE_MEMBER_FN(SaveRegSleepEventHandles_Internal, bool, 0x0092E7A0, void * handleReaderWriter, void * saveStorageWrapper);
	// ECCDB3740458A9BB07FA958498C66F04CE14F94C+1E6
	DEFINE_MEMBER_FN(LoadRegSleepEventHandles_Internal, bool, 0x0092F9D0, void * handleReaderWriter, void * loadStorageWrapper);

	// 00011FEFBFDA69F253C84165B45736A4F0AF02B8+204
	DEFINE_MEMBER_FN(QueueDelayFunctor_Internal, bool, 0x00924F10, void** pFunctor);
...
public:
	...
	struct Output
	{
		...
		DEFINE_MEMBER_FN(Resize, bool, 0x0091FFB0, UInt32 len);
	};
