...
RelocPtr<UInt32 *> g_containerMode(0x02F72288);
RelocAddr<uintptr_t> kHook_ContainerMode_Base(0x0085EC40);
...
RelocAddr<uintptr_t> kHook_BGSKeyword_Base(0x00333CB0);
uintptr_t kHook_BGSKeyword_Create_Return = kHook_BGSKeyword_Base + 6;

// 4C1457C3040DCD34A7E7B2326F1EA2023930C56B+71
RelocAddr <char *> g_gameVersion(0x0155DEF0);
RelocAddr <uintptr_t> kHook_ShowVersion_Offset(0x008EEA60 + 0x78);
...
RelocAddr<uintptr_t> kHook_Crosshair_LookupREFRByHandle_Enter(0x006B03B0 + 0x90);
...
RelocAddr<uintptr_t> kHook_MapMenuMouseWheel_Enter(0x008DCAF0 + 0x18B);
