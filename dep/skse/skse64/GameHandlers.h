...
public:
	...
	DEFINE_MEMBER_FN(Process_Origin, UInt8, 0x007207E0, Actor * form, UInt32 unk04);
};
...
public:
	...
	DEFINE_MEMBER_FN(Process_Origin, UInt8, 0x00720870, Actor * form, UInt32 unk04);
};
...
public:
	...
	DEFINE_MEMBER_FN(Process_Origin, UInt8, 0x007209E0, Actor * form, UInt32 unk04);
};
...
public:
	...
	DEFINE_MEMBER_FN(Process_Origin, UInt8, 0x00720A80, Actor * form, UInt32 unk04);
};
...
public:
	...
	DEFINE_MEMBER_FN(Process_Origin, UInt8, 0x00721D30, Actor * form, UInt32 unk04);
};
...
public:
	...
	DEFINE_MEMBER_FN(Process_Origin, UInt8, 0x00721D50, Actor * form, UInt32 unk04);
};
...
public:
	...
	DEFINE_MEMBER_FN(Process_Origin, UInt8, 0x00720CD0, Actor * form, UInt32 unk04);
};
...
public:
	...
	DEFINE_MEMBER_FN(Process_Origin, UInt8, 0x00720D80, Actor * form, UInt32 unk04);
};
...
public:
	...
	DEFINE_MEMBER_FN(Process_Origin, UInt8, 0x00720DF0, Actor * form, UInt32 unk04);
};
