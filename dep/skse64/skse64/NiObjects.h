...
public:
	...
	DEFINE_MEMBER_FN(DeepCopy, NiStream *, 0x00C52030, NiObject ** result);
};
...
public:
	...
	DEFINE_MEMBER_FN(UpdateNode, void, 0x00C561E0, ControllerUpdateContext * ctx);
};
...
public:
	...
	DEFINE_MEMBER_FN(ctor, void, 0x003D42D0);
	DEFINE_MEMBER_FN(CopyFrom, void, 0x003D43B0, BSFaceGenModel * other);
	DEFINE_MEMBER_FN(SetModelData, bool, 0x003D4A20, const char * meshPath, void * unk1, UInt8 unk2);
	DEFINE_MEMBER_FN(ApplyMorph, UInt8, 0x003D4890, BSFixedString * morphName, TESModelTri * triModel, NiAVObject ** headNode, float relative, UInt8 unk1);
};
...
public:
	...
	DEFINE_MEMBER_FN(ApplyMorph, UInt8, 0x003D7AC0, const char ** morphName, NiAVObject * faceTrishape, float relative, UInt8 unk2);
};
