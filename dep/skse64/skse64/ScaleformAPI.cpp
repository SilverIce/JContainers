...
RelocPtr<ScaleformHeap *> g_scaleformHeap(0x03058C50);
...
RelocAddr<_InvokeFunction> InvokeFunction(0x00ED61D0);
RelocAddr<_GFxAllocateHeap> GFxAllocateHeap(0x00F47AD0);
