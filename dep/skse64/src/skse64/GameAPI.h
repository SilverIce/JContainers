...
public:
	...
	DEFINE_MEMBER_FN(Allocate, void *, 0x00C01DA0, size_t size, size_t alignment, bool aligned);
	DEFINE_MEMBER_FN(Free, void, 0x00C020A0, void * buf, bool aligned);
};
...
public:
	...
	DEFINE_MEMBER_FN(VPrint, void, 0x0085BE40, const char * fmt, va_list args);
