...
#else
        DEFINE_MEMBER_FN(ctor, string_ref *, 0x00C4E840, const char * buf);
        DEFINE_MEMBER_FN(Set, string_ref *, 0x00C4E9D0, const char * buf);
        DEFINE_MEMBER_FN(Release, void, 0x00C4FC10);
#endif
