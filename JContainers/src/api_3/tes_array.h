...
objectWithBooleans converts booleans into integers");
        ...
        REGISTERF(ARGS(fromArray<TESForm*, weak_form_id>), "objectWithForms", "values", nullptr);
...
NEGATIVE_IDX_COMMENT);
        ...
        REGISTERF(itemAtIndex<weak_form_id>, "getForm", "* index default=None", "");
...
NEGATIVE_IDX_COMMENT);
        ...
        REGISTERF(findVal<weak_form_id>, "findForm", "* value searchStartIndex=0", "");
        ...
        REGISTERF(replaceItemAtIndex<weak_form_id>, "setForm", "* index value", "");
...
if addToIndex >= 0 it inserts value at given index. "NEGATIVE_IDX_COMMENT);
        ...
        REGISTERF(addItemAt<weak_form_id>, "addForm", "* value addToIndex=-1", "");
