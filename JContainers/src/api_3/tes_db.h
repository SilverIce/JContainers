...
JDB.solveObj(\".frostfall.arrayC\") will return array containing [\"stringValue\", 1.5, 10, 1.14] values");
        ...
        REGISTERF(solveGetter<FormId>, "solveForm", "path default=None", nullptr);
        ...
        REGISTERF(solveSetter<FormId>, "solveFormSetter", "path value createMissingKeys=false", nullptr);
